% Mechanistic Views: The Hidden Commitments Behind Mechanistic Claims
\pdfoutput=1
...
\title{Mechanistic Views: The Hidden Commitments Behind Mechanistic Claims}
...
The last category matters most: better methods within the same view
cannot reach these, and four of the seven need views for which no
method yet exists.
\end{abstract}
...
one: which commitments a claim has made, and how to tell.
...
\textcolor{red}{[CITE: participation ratio as effective-dimensionality
estimator]}.  \emph{Localizability}: the smallest fraction of components
...
arrivals disagree about vocabulary and agree about the diagnosis, which
is what makes the agreement worth reporting.
