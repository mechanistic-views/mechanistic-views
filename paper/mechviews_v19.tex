...
problem types.  Eight are \emph{clarified}: ill-posed through
view--evidence mismatch, and resolved by declaring the view.  Two are
\emph{reframed} once the required evidence type is identified.  Seven are
\emph{scoped}: experimentally unblocked by adopting a different view.
...
\subsection{A realism criterion}
...
claims \citep{tower2026mechvalidity}.
...
%% ---------------------------------------------------------------
\appendix
\addtocontents{toc}{\protect\vspace{1em}\protect\noindent\textbf{Appendices}\protect\par\protect\vspace{0.3em}}
...
\subsubsection{Decomposition identity}
...
\subsubsection{SAE ``true'' features}
...
\subsubsection{Circuit disagreements}
...
\subsubsection{Cross-model identity}
...
\subsubsection{DAS in random models}
...
\subsubsection{CoT faithfulness}
...
\subsubsection{Intervention limits}
...
\subsubsection{Safety evidence gaps}
...
\subsubsection{Resolution and completeness}
