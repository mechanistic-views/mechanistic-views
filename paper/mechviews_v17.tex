...
framework to three worked examples.  Surveying 17 open problems from
seven sources, we find that 8 are clarified once the view is specified,
2 are reframed once the required evidence type is identified, and 7 are
scoped as structural limits of the view currently used to study them.
The last category matters most: these are ceilings that cannot be
transcended by better methods within the same view.
\end{abstract}
