...
## Option A: [Object](/mechanistic-views/views/object/)
...
## Option B: [Role](/mechanistic-views/views/role/)
...
[Role view](/mechanistic-views/views/role/) for cross-model claims and multi-seed analyses. [Object view](/mechanistic-views/views/object/) for precise single-model circuit recovery at early investigation stages. See the [IOI case study](/mechanistic-views/cases/ioi/) for a concrete example where both views apply to the same circuit.
