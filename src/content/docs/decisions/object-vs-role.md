...
This is the most common implicit decision in interpretability research. Every time someone writes "head 9.9 is the name mover," they have already made it -- they just may not have noticed.

## When you face this decision

Suppose you have found a circuit for indirect object identification (IOI) in GPT-2 Small. You have identified specific heads -- 9.6, 9.9 and 10.0 as name movers, and eight further heads clearing a 2% logit-difference threshold as backup name movers. Now you train GPT-2 Small again from a different random seed. You run circuit discovery on the new model and find that heads 10.4 and 11.1 are doing the name-moving work.
