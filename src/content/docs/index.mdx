...
| [Contrastive](/mechanistic-views/views/contrastive/) | Difference relative to foil | Same contrastive pattern | [Foil-varied patching](/mechanistic-views/views/contrastive/#evidence) | Contrastive explanation | Why $P$ rather than $Q$ |
...
| [Role](/mechanistic-views/views/role/) | Functional role | Role equivalence | [Role-specific causal tests](/mechanistic-views/views/role/#evidence) | [Functional decomposition](/mechanistic-views/formalism/role-graph/) | Functional class |
...
| [Stratified](/mechanistic-views/views/stratified/) | Stratum point | Stratum + local equivalence | [Participation ratio, localization](/mechanistic-views/views/stratified/#evidence) | [Resolution-indexed strata](/mechanistic-views/formalism/stratification/) | Resolution-relative |
...
- [**Methods**](/mechanistic-views/methods/) — how 13 common interpretability methods map to implicit view commitments
- [**Open Problems**](/mechanistic-views/open-problems/) — how common interpretability problems can be better understood using views
- [**About**](/mechanistic-views/about_cite/) — about this project, how to cite it, disclaimers
