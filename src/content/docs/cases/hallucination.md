...
**Limitation.** If correct and incorrect mechanisms share components, the [object view](/views/object/) cannot cleanly localize the failure.
...
The [role view](/views/role/) predicts that the same components may play different roles on different prompts. Role-substitution experiments distinguish this from simple ablation.
...
Evidence: [DAS](/views/subspace/#evidence) on minimal pairs where the correct entity is known and the prompts vary in structure, searching for the subspace whose swap changes the answer from incorrect to correct.

**Outstanding.** Systematic [DAS](/views/subspace/#evidence) analysis with IIA reported for factual recall hallucination has not been published.
...
- **Tier 2** for the [object](/views/object/) and [role](/views/role/) views: patching studies localize factual recall to mid-to-late layers; cross-seed consistency not reported
- **Tier 1** for [subspace](/views/subspace/) and [structural](/views/structural/) views

## What would move to Tier 3

- [DAS](/views/subspace/#evidence) on factual recall tasks with IIA reported and cross-prompt consistency established
