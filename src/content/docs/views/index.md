...
The process view scores 10/27 on its own because the table's criteria are static ones. Its ontology — the formation trajectory — is independent of any static view's, and it forms a family of its own in the paper's partition. It also combines readily: process plus subspace covers the subspace view's 13/27 and adds formation evidence, process plus structural covers 16/27. The process view's unique contribution — formation order, developmental prerequisites, phase transitions — is orthogonal to the static criteria in the table.
