...
The perspectival view holds that mechanism descriptions are relative to the measurement procedure used to produce them. There is no view-independent fact about what "the" mechanism is; there are only mechanism descriptions relative to methods.
