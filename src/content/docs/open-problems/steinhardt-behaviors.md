...
|---|---|---|
| "Propensity ≠ capability" — models can do X but don't reliably do X | Instrumental evidence (capability) ≠ Role evidence (propensity). Showing a circuit *can* do a task isn't showing it *does* the task | [C1 Falsifiability](https://mechanistic-validity.github.io/mechanistic-validity/framework/criteria/construct/falsifiability) — are we measuring the right thing? |
| "Behavioral distributions matter, not just averages" | Average behavior = Instrumental summary. Distribution of behavior = requires understanding of when mechanisms fire and when they don't = Role or Subspace evidence | [E3 Selectivity](https://mechanistic-validity.github.io/mechanistic-validity/framework/criteria/external/selectivity) — does the mechanism fire specifically for this task? |
...
|---|---|---|
| [C1 Falsifiability](https://mechanistic-validity.github.io/mechanistic-validity/framework/criteria/construct/falsifiability) | Usually operationalized as "circuit that *can* produce behavior X" | Should be "circuit that *reliably* produces behavior X under specified conditions" |
| [E3 Selectivity](https://mechanistic-validity.github.io/mechanistic-validity/framework/criteria/external/selectivity) | Rarely tested — most circuit studies don't measure effects on non-target behaviors | Propensity measurement inherently requires specificity: when does the mechanism fire vs. not fire? |
