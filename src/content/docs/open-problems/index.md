...
| **Automated MI at scale** — how do we scale MI to frontier models? | This is engineering, not ontology | The framework provides the evidence standards that automated systems should satisfy — especially [M1 Reliability](https://mechanistic-validity.github.io/mechanistic-validity/framework/criteria/measurement/reliability/) and [V3 Discriminant validity](https://mechanistic-validity.github.io/mechanistic-validity/framework/criteria/interpretive/discriminant-validity/) (does the automated system find real structure or artifacts?) |
