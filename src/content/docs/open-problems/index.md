...
| [Circuit disagreements](/mechanistic-views/open-problems/circuit-disagreements/) | ACDC vs. EAP vs. patching disagree | Which circuit is correct? | [Object](/mechanistic-views/views/object/) vs. [Role](/mechanistic-views/views/role/) vs. [Contrastive](/mechanistic-views/views/contrastive/) | Dissolved |
| [Circuit disagreements](/mechanistic-views/open-problems/circuit-disagreements/) | Circuit size varies by method | Sparse or dense? | [Object](/mechanistic-views/views/object/) vs. [Role](/mechanistic-views/views/role/) vs. [Contrastive](/mechanistic-views/views/contrastive/) | Dissolved |
