...
| [SAE "true" features](/mechanistic-views/open-problems/sae-true-features/) | Do SAEs recover the "true" features? | "True" depends on the view | [Object](/mechanistic-views/views/object/) vs. [Subspace](/mechanistic-views/views/subspace/) | Clarified |
| [Superposition](/mechanistic-views/open-problems/superposition/) | How do models represent more features than dimensions? | Problem, property, or presupposition? | [Object](/mechanistic-views/views/object/) vs. [Subspace](/mechanistic-views/views/subspace/) vs. [Perspectival](/mechanistic-views/views/perspectival/) | Clarified |
| [Circuit disagreements](/mechanistic-views/open-problems/circuit-disagreements/) | ACDC vs. EAP vs. patching disagree | Which circuit is correct? | [Object](/mechanistic-views/views/object/) vs. [Role](/mechanistic-views/views/role/) | Clarified |
...
| [Probe features](/mechanistic-views/open-problems/probe-features/) | Do probes find features the model uses? | "Uses" means four different things | [Instrumental](/mechanistic-views/views/instrumental/) vs. [Subspace](/mechanistic-views/views/subspace/) vs. [Role](/mechanistic-views/views/role/) | Clarified |
...
| [DAS in random models](/mechanistic-views/open-problems/das-random-models/) | DAS finds subspaces in random models | Real subspace or optimization artifact? | [Perspectival](/mechanistic-views/views/perspectival/) diagnosis | Clarified |
| [CoT faithfulness](/mechanistic-views/open-problems/cot-faithfulness/) | Is CoT faithful to internal reasoning? | "Faithful" means four things | [Instrumental](/mechanistic-views/views/instrumental/) vs. [Structural](/mechanistic-views/views/structural/) | Reframed |
...
| [Level of analysis](/mechanistic-views/open-problems/level-of-analysis/) | Ablation ≠ localization | Component or coordinate of a mechanism? | [Object](/mechanistic-views/views/object/) ceiling | Scoped |
...
| [Training dynamics](/mechanistic-views/open-problems/training-dynamics/) | Fine-tuning changes circuits | Enhanced, bypassed, or relocated? | [Process](/mechanistic-views/views/process/) territory | Scoped |
...
|---|---|---|---|
| [Sharkey et al. "Open Problems in MI"](https://arxiv.org/abs/2501.16496) | 2025 | 67 | Comprehensive survey (30 authors) |
