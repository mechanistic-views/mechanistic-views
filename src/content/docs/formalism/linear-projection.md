...
The unembedding projection $W_U$ defines a preferred frame for reading off vocabulary-level predictions. The [Grassmannian](/mechanistic-views/formalism/grassmannian/) formalism generalizes this: instead of projecting onto the unembedding basis, it considers arbitrary subspaces of the residual stream. The [linear classifier](/mechanistic-views/formalism/linear-classifier/) is another observational formalism, but tests for binary concept presence rather than vocabulary-level readout. See the [methods page](/mechanistic-views/methods/) for how [logit/tuned lens](https://learnmechinterp.com/topics/logit-lens-and-tuned-lens/) fits into the evidence landscape.
